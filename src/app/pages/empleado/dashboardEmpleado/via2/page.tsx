...
const TicketsEmpleadosV2: React.FC = () => {
    ...
    const obtenerUltimoId = async () => {
        try {
            const response = await fetch(`${apiHost}/api/contador-v2/ultimo-id`);
            if (!response.ok) {
    ...
    const actualizarConteoBoletos = async (boleto: Boleto) => {
        try {
            const insertarResponse = await fetch(`${apiHost}/api/contador-v2/insert`, {
                method: "POST",
                headers: {
            ...
            const response = await fetch(`${apiHost}/api/conteo-boletos-v2`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
        ...
        const ticketContent = `
            ...
            <body>
                <div class="ticket">
                    ...
                    <p><strong>Ticket No.V2${ticketNumber}</strong></p>
...
export default TicketsEmpleadosV2;
