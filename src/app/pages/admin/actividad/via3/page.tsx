                ...
                fetch(`${apiHost}/api/empleados`)
                    ...
                    .then((data: Empleado[]) => {
                        const loggedUser = data.find(
                            (empleado) => empleado.isLoggedIn && empleado.SelectedVia === 3
                        );
                        ...
                        if (loggedUser) {
                            ...
                            alert("No hay usuarios en la vía 3.");
                        }
                    })
        ...
        <div className="bg-gray-100 min-h-screen flex flex-col">
            ...
            <div className="flex flex-1" >
                ...
                <div className="container mx-auto p-6">
                    <h1 className="text-3xl font-bold text-gray-800 mb-4">Actividad de Via #3</h1>
                    <div className="p-6 space-y-8">
                        <div id="report-content">
                            ...
                            <div className="mb-4 text-center">
                                <h2 className="text-xl font-bold">ACTIVIDAD VIA #3</h2>
                            ...
                            <div>
                                <h2 className="text-lg font-bold mb-4">Conteo de Boletos Actual</h2>
